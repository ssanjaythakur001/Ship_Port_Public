...
export default class StudentList extends Component {
    ...
    private updateRecord = () => {
        ...
        if (collection.length > 0) {
            ...
            if (collection[0]["code"] == undefined || collection[0]["code"].indexOf("_") != "-1" || collection[0]["code"] == "" || collection[0]["code"] == null) {
                toast("Code must have a proper value in required format")
                return;
            }
        }
        else {
            toast("Kindly fill all mendatory fields")
        }
        ...
        axios.put(`${URL}Ship/UpdateShip`, JSON.stringify(json), {
            headers: {
    ...
    public getAllRecord = () => {
        ...
        try {
            ...
            axios.get(`${URL}Ship/GetAllShips`, options
            )
                .then((response) => {
    ...
    public delteObj = (id: React.ChangeEvent<any>) => {
        axios.delete(`${URL}Ship/DeleteShip/${id}`
        )
            .then(res => {
                if (res.status === 200) {
                    this.getAllRecord();
    ...
    deleteData = (a: React.ChangeEvent<any>) => {
    ...
    saveDataOnCreate = () => {
        ...
        axios.post(`${URL}Ship/AddShip`, JSON.stringify(json), {
            headers: {
            ...
            .catch((error) => {
                if (error.response.status == 412) {
                    toast("Code can not be duplicate");
                }
            ...
            <div className="Container">
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Ship Creation</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
                ...
                <div className="form-group">
                    ...
                    <label style={{ textAlign:"center" , width:"80%" }} ><h3>  Ship Listing Page</h3></label>
                ...
                <Modal
                    size="xl"
                    show={this.state.showOnUpdate}
                    onHide={this.handleClose}
                    backdrop="static"
                    keyboard={false}
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Update Ship Information</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
